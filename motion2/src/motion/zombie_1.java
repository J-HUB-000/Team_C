...
public class zombie_1 implements KeyListener {
	private BufferedImage sprite;
	private int x = 400; //처음 캐릭터 그릴 위치 x좌표
	private int y = 432;// 좀비 이미지는 96픽셀이라 y값 늘려야 함 32만큼
	...
	private void loadImage() {
		try {
			this.sprite = ImageIO.read(new File("res/zombie1.png"));
