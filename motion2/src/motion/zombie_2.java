...
public class zombie_2 implements KeyListener {
	private BufferedImage sprite;
	private int x = 450; //처음 캐릭터 그릴 위치 x좌표
	private int y = 432;
	...
	private void loadImage() {
		try {
			this.sprite = ImageIO.read(new File("res/zombie2.png"));
